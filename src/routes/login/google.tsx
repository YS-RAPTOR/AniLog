...
function RouteComponent() {
    ...
    return (
        <SetupLayout
            title="Google Login"
            subtitle="Connect your Google account for cloud backup and YouTube data."
        >
                    ...
                    <div className="space-y-8 flex flex-col items-center">
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground font-medium max-w-sm mx-auto">
                                AniLog needs access to your Google account for
                                Drive cloud synchronization and YouTube
                                integration.
                            </p>
                        </div>
